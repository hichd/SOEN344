...
public class Database {
	...
	public boolean insert(String table, String columnText, String values){
		...
		try {
			...
			// the Simulation because AspectJ will close a connection when the simualtion
	...
	public ResultSet select(String column, String table, String whereClause, String orderbyClause){
		...
		try {
			...
			// Why, oh why, oh why, do we call resultSet.next() here?   --mike
	 ...
	 */
	protected class UnableToCreateDatabaseException extends RuntimeException{
