...
public class Jar {
    ...
    public Resource[][] grabManifests(ResourceCollection[] rcs) {
        ...
        for (int i = 0; i < rcs.length; i++) {
            ...
            for (int j = 0; j < resources[0].length; j++) {
                String name = computeName(resources[0][j], rcs[i]);
	...
	private String computeName(Resource resource, ResourceCollection resourceCollection) {
	...
	private Resource[][] computeResources(ResourceCollection[] rcs, int i) {
